...
const lingYu_1 = require("../lingYu");
const moment_1 = require("moment");
let EasyEasyService = class EasyEasyService {
    constructor(lingYuService) {
        this.lingYuService = lingYuService;
    }
    ...
    async fetchWorkOrderDetailByCode(workOrderCode) {
        ...
        const workOrderDetailResp = await this.lingYuService.fetchWorkOrderDetail(workOrderId);
...
exports.EasyEasyService = EasyEasyService = __decorate([
    ...
    __metadata("design:paramtypes", [lingYu_1.LingYuService])
], EasyEasyService);
